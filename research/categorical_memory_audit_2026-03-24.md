...
File: `C:\apps_ai\OpenBrainLM\memory\decisions.md`
- Exists: YES
...
File: `C:\apps_ai\OpenBrainLM\memory\blockers.md`
- Exists: YES
...
File: `C:\apps_ai\OpenBrainLM\.claude\skills\brain-harness.md`
- Exists: YES
...
## 2. trading_bot_build_2026 Brain — CRITICAL GAP SUSPECTED

### Dual Memory Location — .claude/memory/ AND memory/?
**FAIL — DUAL LOCATION CONFIRMED**

Two memory directories exist:
- `C:\apps_ai\trading_bot_build_2026\.claude\memory\` — contains: `connections.md`, `long_term.md`, `short_term.md`
- `C:\apps_ai\trading_bot_build_2026\memory\` — contains: `blockers.md`, `connections.md`, `decisions.md`, `indicators.md`, `long_term.md`, `short_term.md`
...
**Action required:** Remove or archive `trading_bot_build_2026/.claude/memory/` to prevent stale reads. Claude Code may load `.claude/memory/` preferentially in some contexts.

### CLAUDE.md in .claude/ — Exists?
**FAIL — NO CLAUDE.md IN .claude/**

`C:\apps_ai\trading_bot_build_2026\.claude\` contains:
...
**NO CLAUDE.md exists in `trading_bot_build_2026/.claude/`.** This is a critical gap. Without a project-level CLAUDE.md in `.claude/`, Claude Code cannot auto-load project governance when working in this directory. The project has no bootup identity declaration.
...
File: `C:\apps_ai\trading_bot_build_2026\memory\decisions.md`
- Exists: YES
...
File: `C:\apps_ai\trading_bot_build_2026\memory\blockers.md`
- Exists: YES
...
File: `C:\apps_ai\trading_bot_build_2026\memory\indicators.md`
- Exists: YES
...
- Locked formula references noted as REFERENCE ONLY per Austin directive
...
|---|---|---|---|---|
| 1 | `trading_bot_build_2026/.claude/memory/` exists alongside `memory/` — stale old location not removed | HIGH | Trading Bot | Remove/archive `.claude/memory/` to eliminate stale read risk |
| 2 | No `CLAUDE.md` in `trading_bot_build_2026/.claude/` | CRITICAL | Trading Bot | Create project CLAUDE.md with governance, rules, and memory file paths |
...
1. **CRITICAL**: `trading_bot_build_2026/.claude/CLAUDE.md` does not exist. Claude Code cannot auto-load project governance for this project.
