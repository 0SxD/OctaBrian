...
You are helping Austin with the OpenBrainLM project — a brain harness for LLMs. The system uses:
...
Save all research responses to: `C:\apps_ai\OpenBrainLM\research\`
