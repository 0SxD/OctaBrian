...
```
| 2026-03-24 | nautilus_trader\ is PRIMARY project; trading_bot_build_2026\ is SOURCE | Clean separation: NT project = execution environment. Trading bot = indicator/strategy source + sandbox history. Agents access both. | Active | 1.0 | Austin directive 2026-03-24 |
```
...
| 2A | trading_bot_build_2026/memory/decisions.md | "Python 3.13" dated 2026-03-24 | PASS |
| 2B | trading_bot_build_2026/memory/decisions.md | "nautilus_trader PRIMARY" dated 2026-03-24 | PASS |
