# Third-Party Repo Inventory — Austin's AI Workspace
> Date: 2026-03-25
> Scope: trading_bot_build_2026, nautilus_trader, OpenBrainLM
...
## Already Cloned (`C:\apps_ai\_repos\`)

Only one repo found cloned:

| Repo | Clone Path |
|---|---|
| nautechsystems/nautilus_trader | `C:\apps_ai\_repos\nautilus_trader\` |
...
All OpenBrainLM Phase 2+ vision repos. Hold until Phase 2 work begins. Austin directive (2026-03-23): "ALL biology, biomimicry, 8-layer Python code is TABLED. Do NOT touch openbrainlm/*.py until current operational work is stable."
