...
| Artifact | Path |
|---|---|
| Module registry (live) | `trading_bot_build_2026/scripts/mctx_module_registry.py` |
| Indicator hub (live) | `trading_bot_build_2026/strategy/indicator_hub.py` |
| Fibonacci bands | `trading_bot_build_2026/indicators/fibonacci_bands.py` |
...
| Dynamic vs static exit report | `trading_bot_build_2026/phase5_dynamic_vs_static_report.md` |
